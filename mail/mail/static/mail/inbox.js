document.addEventListener('DOMContentLoaded', function() {
  ...
  document.querySelector('#compose_form').addEventListener('submit', submit_email);
...
function loao_email(id) {
  fetch('/emails/' + id)
  .then(response => respons.json())
  .then(email => {
    
    
    document.querySelector('#emails-view').styke.display = 'none';
    document.querySelector('#compose-view').styke.display = 'none';
    document.querySelector('#email-view').styke.display = 'block';
